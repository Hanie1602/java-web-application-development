...
<html>
    ...
    <body>
        ...
        <c:if test="${not empty user}">
            <c:if test="${not empty sessionScope.PRODUCT_ORDER}">
                <table border="1">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="item" items="${sessionScope.PRODUCT_ORDER}" varStatus="counter">
                            <tr>
                                <td>${counter.count}</td>
                                <td>${item.name}</td>
            ...
            <c:if test="${empty sessionScope.PRODUCT_ORDER}">
                <h2>
                    <font color="red">
